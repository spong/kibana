...
import { DETECTION_ENGINE_RULES_EXPORT_TO_INDEX } from '../../../../../common/constants';
...
export const exportRulesToIndexRoute = (
  router: SecuritySolutionPluginRouter,
  config: ConfigType
) => {
  router.post(
    {
      path: `${DETECTION_ENGINE_RULES_EXPORT_TO_INDEX}`,
      validate: {
    ...
    async (context, request, response) => {
      ...
      // TODO: Retrieve options from request (override rules, index-name?, etc)
      // TODO: Create index/ILM
      // TODO: Dump rules to index (scrub API get and such if needed)
      // TODO: Create Kibana DataView
