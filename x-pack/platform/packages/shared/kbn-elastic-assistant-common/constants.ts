...
// Workflow Generation
export const ELASTIC_AI_ASSISTANT_WORKFLOW_GENERATION_URL =
  `${ELASTIC_AI_ASSISTANT_INTERNAL_URL}/workflow_generation` as const;
export const ELASTIC_AI_ASSISTANT_WORKFLOW_GENERATION_GENERATE_URL =
  `${ELASTIC_AI_ASSISTANT_WORKFLOW_GENERATION_URL}/generate` as const;
export const ELASTIC_AI_ASSISTANT_WORKFLOW_GENERATION_EXECUTE_URL =
  `${ELASTIC_AI_ASSISTANT_WORKFLOW_GENERATION_URL}/execute` as const;
export const ELASTIC_AI_ASSISTANT_WORKFLOW_GENERATION_ACTION_URL =
  `${ELASTIC_AI_ASSISTANT_WORKFLOW_GENERATION_URL}/action` as const;
